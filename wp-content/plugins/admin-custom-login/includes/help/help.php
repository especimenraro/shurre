			...
			<table class="form-table">
				...
				<tr class="radio-span">
					<td>
						...
						<h4><?php esc_html_e('If you are enjoying using our Admin Custom Login plugin and find it useful, then please consider writing a positive feedback. Your feedback will help us to encourage and support the plugins continued development and better user support.', WEBLIZAR_ACL)?></h4>
			...
			<table class="form-table">
				...
				<tr class="radio-span">
					<td>
						...
						<h4><?php esc_html_e('If you have any suggestion or features in your mind then please share us. We will try our best to add them in this plugin.', WEBLIZAR_ACL)?>  </h4>
			...
			<table class="form-table">
				...
				<tr class="radio-span">
					<td>
						...
						<h4><?php esc_html_e('Question : How to convert Plguin into My Language?', WEBLIZAR_ACL)?> </h4>
