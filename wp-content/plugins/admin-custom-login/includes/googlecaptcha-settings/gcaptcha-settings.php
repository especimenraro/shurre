		...
		<div class="panel-body">
			<table class="form-table">
				...
				<tr class="radio-span">
					<td>
						<span>
							<input type="radio" name="enable_gacptcha" value="yes" id="login_enable_gcaptcha1" <?php if($login_enable_gcaptcha=="yes")echo "checked"; ?> />&nbsp;<?php esc_html_e('Enable', WEBLIZAR_ACL)?><br>
						</span>
						<span>
							<input type="radio" name="enable_gacptcha" value="no" id="login_enable_gcaptcha2" <?php if($login_enable_gcaptcha=="no")echo "checked"; ?> />&nbsp;<?php esc_html_e('Disable', WEBLIZAR_ACL)?><br>
						</span>
				...
				<tr class="radio-span">
					<td>
						<span>
							<input type="radio" name="v_gacptcha" value="v2" id="login_v_gcaptcha1" <?php if($login_v_gcaptcha=="v2")echo "checked"; ?> />&nbsp;<?php esc_html_e('v2', WEBLIZAR_ACL)?><br>
						</span>
						<span>
							<input type="radio" name="v_gacptcha" value="v3" id="login_v_gcaptcha2" <?php if($login_v_gcaptcha=="v3")echo "checked"; ?> />&nbsp;<?php esc_html_e('v3', WEBLIZAR_ACL)?><br>
						</span>
				...
				<tr class="radio-span recaptcha_keys_v2">
					<td>
						<span>
							<input type="radio" name="acl_gcaptcha_theme" value="yes" id="acl_gcaptcha_theme1" <?php if($acl_gcaptcha_theme=="yes")echo "checked"; ?> />&nbsp;<?php esc_html_e('Light', WEBLIZAR_ACL)?><br>
						</span>
						<span>
							<input type="radio" name="acl_gcaptcha_theme" value="no" id="acl_gcaptcha_theme2" <?php if($acl_gcaptcha_theme=="no")echo "checked"; ?> />&nbsp;<?php esc_html_e('Dark', WEBLIZAR_ACL)?><br>
						</span>
					</td>
				</tr> 
