...
?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			<div class="col s3 m3 l1 offset-l2 ">
			...
			?>
				...
				<a class="btn-floating btn-large red modal-trigger" disabled href="#agrega-post"><i class="material-icons">add</i></a>
			<?php
			} else {
			...
			<div class="modal" id="agrega-post">
				...
				<div class="modal-content">
					...
					<h4>Agrega tu Receta</h4>
						...
						<div class="row">
							...
							<form class="col s8" method="post" action="wp-admin/admin-ajax.php" enctype="multipart/form-data">
				...
				<div class="col s9 l6 contenedor-post ">
